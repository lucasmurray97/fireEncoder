#!/bin/bash
### AE
python train_ae.py --latent_dim 256 --epochs 100 --network AE --instance hetero_1 --lr1 1e-3
python train_ae.py --latent_dim 256 --epochs 100 --network AE --instance hetero_1 --lr1 1e-4
python train_ae.py --latent_dim 256 --epochs 100 --network AE --instance hetero_1 --lr1 1e-5

python train_ae.py --latent_dim 128 --epochs 100 --network AE --instance hetero_1 --lr1 1e-3
python train_ae.py --latent_dim 128 --epochs 100 --network AE --instance hetero_1 --lr1 1e-4
python train_ae.py --latent_dim 128 --epochs 100 --network AE --instance hetero_1 --lr1 1e-5

python train_ae.py --latent_dim 64 --epochs 100 --network AE --instance hetero_1 --lr1 1e-3
python train_ae.py --latent_dim 64 --epochs 100 --network AE --instance hetero_1 --lr1 1e-4
python train_ae.py --latent_dim 64 --epochs 100 --network AE --instance hetero_1 --lr1 1e-5
